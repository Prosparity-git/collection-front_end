export const VEHICLE_STATUS_OPTIONS = [
  ...
  { value: "Repossessed", label: "Repossessed", color: "bg-red-100 text-red-800 border border-red-200" },
  ...
  { value: "Repossessed_sold", label: "Repossessed Sold", color: "bg-purple-100 text-purple-800 border border-purple-200" },
];
